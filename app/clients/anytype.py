...
class AnytypeClient:
    ...
    async def create_space(self, request: CreateSpaceRequest, token: Optional[str] = None) -> SpaceDetails:
        """Create a new space"""
    ...
    async def get_spaces(self, limit: int = 50, offset: int = 0, token: Optional[str] = None) -> List[SpaceDetails]:
        """Get list of spaces"""
        headers = self._get_headers()
    ...
    async def get_members(self, request: GetMembersRequest, token: Optional[str] = None) -> List[MemberDetails]:
        """Get space members"""
        data = prepare_request_data(request.dict())
    ...
    async def create_object(self, request: CreateObjectRequest, token: Optional[str] = None) -> ObjectDetails:
        """Create a new object"""
        data = prepare_request_data(request.dict())
        space_id = data.pop("space_id")
        headers = self._get_headers()
    ...
    async def get_object(self, space_id: str, object_id: str, token: Optional[str] = None) -> ObjectDetails:
        """Get object details"""
        headers = self._get_headers()
        result = await make_request(
            "GET",
    ...
    async def get_objects(self, request: GetObjectsRequest, token: Optional[str] = None) -> List[ObjectDetails]:
        """Get objects list"""
        data = prepare_request_data(request.dict())
        space_id = data.pop("space_id")
        headers = self._get_headers()
    ...
    async def delete_object(self, request: DeleteObjectRequest, token: Optional[str] = None) -> BaseResponse:
        """Delete an object"""
        data = prepare_request_data(request.dict())
        space_id = data.pop("space_id")
    ...
    async def search_objects(self, request: SearchRequest, token: Optional[str] = None) -> List[ObjectDetails]:
        """Search for objects"""
        data = prepare_request_data(request.dict())
        space_id = data.pop("space_id")
        headers = self._get_headers()
    ...
    async def global_search(self, request: GlobalSearchRequest, token: Optional[str] = None) -> List[ObjectDetails]:
    ...
    async def get_types(self, request: GetTypesRequest, token: Optional[str] = None) -> List[TypeDetails]:
        """Get object types"""
        data = prepare_request_data(request.dict())
        space_id = data.pop("space_id")
        headers = self._get_headers()
    ...
    async def get_templates(self, request: GetTemplatesRequest, token: Optional[str] = None) -> List[TemplateDetails]:
        """Get templates"""
        data = prepare_request_data(request.dict())
        space_id = data.pop("space_id")
    ...
    async def get_export(self, space_id: str, object_id: str, format: ExportFormat, token: Optional[str] = None) -> str:
